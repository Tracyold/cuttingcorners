...
export default function Home() {
  ...
  // Persisted refs for lock/cooldown so JSX click handlers can safely access them
  ...
  useEffect(() => {
    ...
    const defocus = (card: Element) => {
      ...
      el.style.transition =
        'opacity 400ms ease-out, filter 400ms ease-out, transform 400ms ease-out';
      ...
      if (icon) {
        icon.style.transition =
          'transform 520ms ease-out, filter 520ms ease-out, opacity 520ms ease-out';
    ...
    const focus = (card: Element) => {
      ...
      if (icon) {
        icon.style.transition =
          'transform 640ms ease-out, filter 640ms ease-out, opacity 640ms ease-out';
  ...
  const tapDown = () => {
    ...
    document.body.style.overflow = '';
    const { bottom } = computeSectionTopBottom(section);
      ...
      <main>
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundImage:
                'url(https://customer-assets.emergentagent.com/job_1e0d6e37-2077-4a48-b9fe-d77e61594e60/artifacts/yu1iknms_IMG_3821.jpeg)',
              opacity: 0.2,
            }}
          />
            ...
            >
              <div
                ...
                style={{
                  height: '80px',
                  background:
                    'linear-gradient(to bottom, rgba(5,5,5,1) 0%, rgba(5,5,5,0) 100%)',
                  position: 'absolute',
                  left: 0,
                  right: 0,
                  zIndex: 10,
              ...
              <div
                ...
                style={{
                  height: '80px',
                  background:
                    'linear-gradient(to top, rgba(5,5,5,1) 0%, rgba(5,5,5,0) 100%)',
                  position: 'absolute',
                  left: 0,
                  right: 0,
                  bottom: 0,
              ...
              >
                ...
                <div
                  style={{
                    ...
                    height: '32px',
                    background:
                      'linear-gradient(to bottom, rgba(212,175,55,0.6), rgba(212,175,55,0))',
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                  ...
                  <a href="tel:4802854595" className="btn-secondary">
                    Call 480-286-4595
                  </a>
                </div>
              </div>
