module.exports=[9122,a=>a.a(async(b,c)=>{try{var d=a.i(8171),e=a.i(27669),f=a.i(41910),g=a.i(76165),h=b([g]);[g]=h.then?(await h)():h;let j=[{id:"dashboard",label:"Dashboard",icon:"⬡",route:"/admin/dashboard"},{id:"products",label:"Products",icon:"◈",route:"/admin/products"},{id:"portfolio",label:"Portfolio",icon:"◻",route:"/admin/portfolio"},{id:"users",label:"User List",icon:"◯",route:"/admin/users"}],k=`
...
`;function i({children:a,activeNav:b}){let c=(0,f.useRouter)(),[h,i]=(0,e.useState)(!0),[l,m]=(0,e.useState)(0),[n,o]=(0,e.useState)(!1),p=(0,e.useRef)(null);(0,e.useEffect)(()=>{!async function(){let{data:{session:a}}=await g.supabase.auth.getSession();if(!a)return c.replace("/admin/login");let{data:b}=await g.supabase.from("admin_users").select("admin_user_id").eq("admin_user_id",a.user.id).single();if(!b){await g.supabase.auth.signOut(),c.replace("/admin/login");return}i(!1),m(0)}()},[c]),(0,e.useEffect)(()=>{if(!n)return;let a=a=>{p.current&&!p.current.contains(a.target)&&o(!1)};return document.addEventListener("click",a),()=>document.removeEventListener("click",a)},[n]);let q=async()=>{await g.supabase.auth.signOut(),c.push("/admin/login")};return h?(0,d.jsx)("div",{style:{background:"#060606",height:"100vh"}}):(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)("style",{children:k}),(0,d.jsxs)("div",{className:"mob-topbar",ref:p,children:[(0,d.jsx)("span",{className:"mob-brand",children:"CCG"}),(0,d.jsxs)("button",{className:`mob-burger${n?" open":""}`,onClick:a=>{a.stopPropagation(),o(a=>!a)},"aria-label":"Toggle admin menu",children:[(0,d.jsx)("span",{className:"mb"}),(0,d.jsx)("span",{className:"mb"}),(0,d.jsx)("span",{className:"mb"})]})]}),(0,d.jsxs)("div",{className:`mob-dropdown${n?" open":""}`,children:[j.map(a=>(0,d.jsx)("button",{className:`mob-dropdown-item${b===a.id?" on":""}`,onClick:()=>{var b;return b=a.route,void(o(!1),c.push(b))},children:a.label},a.id)),(0,d.jsx)("button",{className:"mob-dropdown-signout",onClick:q,children:"Sign Out"})]}),(0,d.jsxs)("div",{className:"shell",children:[(0,d.jsxs)("div",{className:"sb",children:[(0,d.jsxs)("div",{className:"sb-brand",children:[(0,d.jsxs)("div",{className:"sb-name",children:["Cutting Corners",(0,d.jsx)("br",{}),"Gems"]}),(0,d.jsx)("div",{className:"sb-role",children:"Admin"})]}),(0,d.jsx)("nav",{className:"sb-nav",children:j.map(a=>(0,d.jsxs)("button",{className:`ni ${b===a.id?"on":""}`,onClick:()=>c.push(a.route),children:[(0,d.jsx)("span",{className:"ni-ic",children:a.icon}),a.label,"dashboard"===a.id&&l>0&&(0,d.jsx)("span",{className:"ni-bell",children:(0,d.jsx)("span",{className:"ni-badge",children:l>9?"9+":l})})]},a.id))}),(0,d.jsx)("div",{className:"sb-foot",onClick:q,children:"Sign Out"})]}),(0,d.jsx)("div",{className:"main",children:a})]})]})}a.s(["adminCss",0,k,"default",()=>i]),c()}catch(a){c(a)}},!1)];

//# sourceMappingURL=components_admin_AdminLayout_tsx_499dc959._.js.map