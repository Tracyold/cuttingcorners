      ...
      <main>
        ...
        <section style={{ padding: '140px 0 80px', background: 'transparent' }}>
          <div className="container-custom" style={{ maxWidth: '1160px', width: '100%', margin: '0 auto' }}>
            ...
            <div className="fr-card-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2px' }}>
              {valueProps.map(v => (
                <div key={v.n} className="fr-card" style={{ padding: '36px 32px', background: 'var(--bg)', border: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <p className="fr-card-body" style={{ fontFamily: 'Comfortaa, sans-serif', fontSize: '15px', color: 'rgba(var(--text-rgb, 238,238,238),0.85)', lineHeight: 1.85 }}>{v.body}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section style={{ padding: '80px 0', background: 'transparent', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
          <div className="container-custom" style={{ maxWidth: '1160px', width: '100%', margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: 'Oranienbaum, serif', fontSize: 'clamp(23px, 3vw, 38px)', color: 'rgba(var(--text-rgb, 238,238,238),0.85)', textAlign: 'center', marginBottom: '48px' }}>Built for Different Situations</h2>
            <div className="fr-card-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '2px' }}>
              {useCases.map(u => (
                <div key={u.title} className="fr-card" style={{ padding: '36px 32px', background: 'var(--bg)', border: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <p className="fr-card-body" style={{ fontFamily: 'Comfortaa, sans-serif', fontSize: '15px', color: 'rgba(var(--text-rgb, 238,238,238),0.85)', lineHeight: 1.85 }}>{u.body}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section style={{ padding: '80px 0', background: '#080808', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
          <div className="container-custom" style={{ maxWidth: '1220px', width: '100%', margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: 'Oranienbaum, serif', fontSize: 'clamp(23px, 3.5vw, 42px)', color: 'rgba(var(--text-rgb, 238,238,238),0.85)', textAlign: 'center', marginBottom: '17px' }}>What a Report Looks Like</h2>
