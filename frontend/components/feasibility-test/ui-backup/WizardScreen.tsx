        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            {phaseSteps.length > 1 && phaseIndex >= 0 && (
              <span style={{ ...T.body, fontSize: 'clamp(15px,1.8vw,17px)' }}>
      ...
      {currentStep.type === 'category-complete' && (
        <div className="wiz-complete" key={`cc-${stepIndex}`}>
          <div style={{ textAlign: 'center', padding: '24px 0 32px' }}>
            ...
            <p style={{ ...T.large, fontSize: 'clamp(26px,5vw,34px)', marginBottom: 12 }}>
              {currentStep.title}
            </p>
            <p style={{
              ...T.body,
      ...
      {currentStep.type === 'stone-info' && (
        <div className="wiz-slide" key={`si-${stepIndex}`} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          {[
            ...
            <div key={field.key}>
              <label style={{ display: 'block', ...T.body, fontSize: 'clamp(13px,1.6vw,15px)', marginBottom: 7 }}>
                {field.label}
              </label>
              <input
                type="text"
