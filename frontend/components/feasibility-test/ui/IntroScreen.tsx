...
export default function IntroScreen({
  ...
  return (
    <div className="center-stage">
      ...
      {/* Skip button — top right, in flow */}
      <div className="intro-skip-row">
        {introPhase !== 'begin' && (
          <button onClick={onSkip} className="intro-skip-btn">Skip</button>
        )}
      </div>
      ...
      </div>{/* end intro-middle */}

      {/* Begin button — pinned to bottom center */}
      {introPhase === 'begin' && (
        <div className="intro-begin-row">
