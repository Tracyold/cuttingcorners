  ...
  return (
    <>
      <style>{`
        ...
        .chat-header-lbl{font-family:var(--font-ui);font-size:15px;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--bg-deep)}
        .chat-header-close{background:transparent;border:0.5px solid rgba(0,0,0,0.2);color:var(--bg-deep);width:30px;height:30px;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:16px;font-weight:700}
        .chat-msgs{flex:1;overflow-y:auto;padding:14px;display:flex;flex-direction:column;gap:0;justify-content:flex-end}
        .chat-empty{font-family:var(--font-ui);font-style:italic;font-size:16px;color:var(--text-muted);text-align:center;margin:auto;opacity:0.6}
        ...
        .bubble{max-width:78%;padding:9px 13px;font-family:var(--font-ui);font-size:17px;line-height:1.5;word-break:break-word}
        ...
        .msg-time{font-family:var(--font-ui);font-size:13px;color:var(--text-muted);margin-top:3px;padding:0 3px}
        ...
        .date-divider-lbl{font-family:var(--font-ui);font-size:13px;letter-spacing:0.12em;text-transform:uppercase;color:var(--text-muted);white-space:nowrap;opacity:0.6}
        ...
        .chat-attach{background:transparent;border:0.5px solid var(--bdr2);color:var(--text-muted);width:36px;height:36px;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:19px;flex-shrink:0;transition:border-color 150ms ease}
        .chat-attach:hover{border-color:var(--gold)}
        .chat-attach:disabled{opacity:0.4;cursor:not-allowed}
        .chat-input{flex:1;background:var(--bg);border:0.5px solid var(--bdr2);border-radius:6px;padding:9px 13px;color:var(--text);font-family:var(--font-ui);font-size:17px;outline:none;transition:border-color 150ms ease}
        .chat-input:focus{border-color:var(--gold)}
        .chat-send{background:var(--gold);border:none;width:36px;height:36px;color:var(--bg-deep);font-weight:700;cursor:pointer;font-size:19px;flex-shrink:0;display:flex;align-items:center;justify-content:center;transition:opacity 150ms ease}
