  ...
  return (
    <>
      <style>{`
        ...
        .tab-icon{font-size:21px;opacity:0.45;transition:all 180ms ease}
        .tab-lbl{font-family:var(--font-mono);font-size:11px;letter-spacing:0.14em;text-transform:uppercase;color:var(--text-muted);transition:all 180ms ease}
