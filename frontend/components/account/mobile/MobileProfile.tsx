  ...
  return (
    <>
      <style>{`
        ...
        .profile-label{font-family:var(--font-mono);font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:var(--text-muted);margin-bottom:6px;display:block}
        .profile-input{width:100%;background:var(--bg-card);border:0.5px solid var(--bdr2);color:var(--text);font-family:var(--font-ui);font-size:17px;padding:10px 12px;outline:none;transition:border-color 150ms ease}
        .profile-input:focus{border-color:var(--gold)}
        .profile-save{width:100%;background:var(--gold);color:var(--bg-deep);border:none;padding:13px;font-family:var(--font-mono);font-size:13px;letter-spacing:0.2em;text-transform:uppercase;cursor:pointer;margin-top:8px;transition:opacity 180ms ease}
        ...
        .dr-foot-btn{background:none;border:none;padding:0;text-align:left;font-family:var(--font-mono);font-size:13px;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-muted);cursor:pointer;transition:color 160ms ease;width:100%;margin-bottom:10px}
