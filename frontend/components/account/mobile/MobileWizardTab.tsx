  ...
  return (
    <>
      <style>{`
        ...
        .wiz-tip-icon{color:var(--gold);font-size:17px;flex-shrink:0;margin-top:1px}
        .wiz-tip-text{font-family:var(--font-ui);font-size:14px;color:var(--text-muted);line-height:1.6;flex:1}
        .wiz-tip-text strong{color:var(--text);font-weight:500}
        .wiz-tip-close{background:none;border:none;color:var(--text-muted);font-size:15px;cursor:pointer;flex-shrink:0;padding:0;line-height:1;margin-top:1px}
      `}</style>
