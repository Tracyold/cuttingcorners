  ...
  return (
    <>
      <style>{`
        ...
        .inv-photo{width:100%;height:100%;object-fit:cover;display:flex;align-items:center;justify-content:center;font-size:49px;background:var(--bg-deep)}
        ...
        .inv-tap-hint{font-family:var(--font-ui);font-size:11px;letter-spacing:0.12em;text-transform:uppercase;color:rgba(255,255,255,0.5);margin-top:10px}
        ...
        .inv-drawer-close{background:none;border:0.5px solid #ccc;color:#555;width:30px;height:30px;display:flex;align-items:center;justify-content:center;cursor:pointer;font-size:17px;border-radius:50%}
        ...
        .pdf-stamp-text{font-family:var(--font-mono);font-size:25px;font-weight:700;color:#c0392b;letter-spacing:0.15em;text-transform:uppercase}
        ...
        .pdf-brand{font-family:var(--font-display);font-size:21px;color:#1a1a1a;letter-spacing:0.04em}
        .pdf-brand-sub{font-size:13px;letter-spacing:0.15em;text-transform:uppercase;color:#888;margin-top:2px}
        .pdf-inv-num{font-family:var(--font-mono);font-size:11px;color:#888;text-align:right}
        .pdf-to{margin-bottom:20px}
        .pdf-label{font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:#888;margin-bottom:4px;font-family:var(--font-mono)}
        .pdf-name{font-size:17px;color:#1a1a1a;font-family:var(--font-ui);font-weight:600}
        .pdf-addr{font-size:15px;color:#555;font-family:var(--font-ui);line-height:1.6}
        .pdf-items{width:100%;border-collapse:collapse;margin-bottom:20px}
        .pdf-items th{font-size:11px;letter-spacing:0.18em;text-transform:uppercase;color:#888;font-family:var(--font-mono);padding:8px 0;border-bottom:1px solid #e0e0e0;text-align:left;font-weight:400}
        ...
        .pdf-total-amt{font-size:23px;font-weight:700;color:#1a1a1a;font-family:var(--font-mono)}
        .pdf-footer{margin-top:24px;padding-top:16px;border-top:0.5px solid #e0e0e0;text-align:center}
        .pdf-footer-txt{font-size:13px;color:#aaa;font-family:var(--font-ui);line-height:1.6}
        ...
        .pdf-gia-btn{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;background:transparent;color:#0c70b8;border:1px solid #0c70b8;padding:11px;font-family:var(--font-mono);font-size:13px;letter-spacing:0.18em;text-transform:uppercase;cursor:pointer;margin-top:8px;text-decoration:none;transition:opacity 180ms ease}
