...
import ChatMessage from '../../shared/useChatView'

/**
 * IMPORTANT:
 * We DO NOT assume a ChatMessage type exists in hooks.
 * We derive structure directly from runtime usage in THIS file.
 */
type ChatMessage = {
  chat_message_id: string
  created_at: string
  actor: 'ACCOUNT' | 'ADMIN' | 'SYSTEM' | string
  body: string | null
