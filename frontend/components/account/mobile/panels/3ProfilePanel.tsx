  ...
  return (
    <div ref={elementRef} className={`slide-panel${open ? ' open' : ''}`}>
      ...
      <div className="profile-body">
        ...
        {profileFlash && (
          <div style={{ fontFamily: 'var(--font-ui)', fontSize: 16, color: 'var(--accent)', marginBottom: 16 }}>
            ✓ Saved
          </div>
        )}
        ...
        <div style={{
          ...
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: 25, color: 'var(--accent)' }}>
            {invoiceCount}
          </span>
          <span style={{ fontSize: 17, color: 'var(--text-muted)', marginLeft: 8 }}>
            items purchased
          </span>
          <span style={{ margin: '0 10px', color: 'var(--bdr2)' }}>|</span>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: 19, color: 'var(--accent)' }}>
        ...
        <div style={{ marginBottom: 28, paddingBottom: 22, borderBottom: '0.5px solid var(--bdr2)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, padding: '12px 0' }}>
            <div>
              ...
              <div style={{ fontFamily: 'var(--font-ui)', fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.45 }}>
          ...
          <p style={{ fontFamily: 'var(--font-ui)', fontSize: 15, color: 'var(--text-muted)', marginTop: 8, lineHeight: 1.6, opacity: 0.7 }}>
      ...
      {showDeleteModal && (
        <>
          ...
          >
            ...
            <p style={{ fontFamily: 'var(--font-ui)', fontSize: 16, color: 'var(--text-muted)', marginBottom: 16 }}>
            ...
            <input
              ...
              style={{
                width: '100%', padding: 10, fontFamily: 'var(--font-ui)', fontSize: 16,
                border: '1px solid var(--bdr2)', borderRadius: 4, background: 'var(--bg-light)',
                color: 'var(--text)', marginBottom: 12, boxSizing: 'border-box',
              }}
            />
            {deleteError && (
              <div style={{ fontFamily: 'var(--font-ui)', fontSize: 13, color: '#f87171', marginBottom: 12 }}>
                {deleteError}
              </div>
            )}
            <div style={{ display: 'flex', gap: 8 }}>
              <button
                onClick={() => setShowDeleteModal(false)}
                style={{
                  flex: 1, padding: 10, fontFamily: 'var(--font-ui)', fontSize: 16,
