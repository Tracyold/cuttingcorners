      ...
      >
        ...
        <div className="wo-body">
          ...
          <div className="wo-topbar">
            ...
            <span style={{
              fontFamily: 'var(--font-mono-mob)', fontSize: 'clamp(0.8125rem, 3.5vw, 0.9375rem)',
            ...
            <div className="wo-content">
              ...
              {adminInfo && (
                <div style={{ marginBottom: 16 }}>
                  <div style={{
                    fontFamily: 'var(--font-mono-mob)', fontSize: 'clamp(0.75rem, 3.2vw, 0.875rem)', letterSpacing: '0.18em',
              ...
              {showAddrEdit && (
                <div style={{
                  ...
                  {!addrConfirmed ? (
                    <>
                      <p style={{ fontFamily: 'var(--font-ui-mob)', fontSize: 'clamp(0.875rem, 3.8vw, 1.0rem)', color: 'var(--text-mob-muted)', lineHeight: 1.6, marginBottom: 10 }}>
                      ...
                      <input
                        ...
                        style={{
                          ...
                          color: 'var(--text-mob)', fontFamily: 'var(--font-ui-mob)', fontSize: 'clamp(0.875rem, 3.8vw, 1.0rem)',
                      ...
                      <div style={{ display: 'flex', gap: 8 }}>
                        <button
                          ...
                          style={{
                            ...
                            padding: '9px 14px', fontFamily: 'var(--font-mono-mob)', fontSize: 'clamp(0.75rem, 3.2vw, 0.875rem)',
                        ...
                        <button
                          ...
                          style={{
                            ...
                            padding: '9px 12px', fontFamily: 'var(--font-mono-mob)', fontSize: 'clamp(0.75rem, 3.2vw, 0.875rem)',
                    ...
                    <p style={{ fontFamily: 'var(--font-ui-mob)', fontSize: 'clamp(0.875rem, 3.8vw, 1.0rem)', color: 'var(--accent)' }}>
              ...
              <div style={{ marginBottom: 20 }}>
                {detailRows.map(row => (
                  <div key={row.label} style={{
                    ...
                    <span style={{ fontFamily: 'var(--font-mono-mob)', fontSize: 'clamp(0.75rem, 3.2vw, 0.875rem)', letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--text-mob-muted)' }}>
                      {row.label}
                    </span>
                    <span style={{ fontFamily: 'var(--font-ui-mob)', fontSize: 'clamp(0.875rem, 3.8vw, 1.0rem)', color: 'var(--text-mob)', textAlign: 'right', maxWidth: '60%' }}>
                      {row.val}
                    </span>
                  </div>
                ))}
              ...
              {wo.description && (
                <div style={{ marginBottom: 20 }}>
                  <div style={{ fontFamily: 'var(--font-mono-mob)', fontSize: 'clamp(0.75rem, 3.2vw, 0.875rem)', letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--text-mob-muted)', marginBottom: 6 }}>
                    Description
                  </div>
                  <p style={{ fontFamily: 'var(--font-ui-mob)', fontSize: 'clamp(0.9375rem, 4vw, 1.0625rem)', color: 'var(--text-mob)', lineHeight: 1.7 }}>
                    {wo.description}
                  </p>
                </div>
              )}
              ...
              {wo.notes && (
                <div style={{ marginBottom: 20 }}>
                  ...
                  <p style={{ fontFamily: 'var(--font-ui-mob)', fontSize: 'clamp(0.9375rem, 4vw, 1.0625rem)', color: 'var(--text-mob-muted)', lineHeight: 1.7 }}>
                    {wo.notes}
                  </p>
                </div>
              )}
              ...
              {wo.estimated_price && (
                <div style={{
                  ...
                  <span style={{ fontFamily: 'var(--font-mono-mob)', fontSize: 'clamp(0.75rem, 3.2vw, 0.875rem)', letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--text-mob-muted)' }}>
                    Quoted Price
                  </span>
              ...
              {wo.status === 'CONFIRMED' && (
                <div style={{ padding: 14, background: 'var(--bg-mob-card)', border: '0.5px solid var(--bdr2-mob)', marginBottom: 16 }}>
                  <p style={{ fontFamily: 'var(--font-ui-mob)', fontSize: 'clamp(0.9375rem, 4vw, 1.0625rem)', color: 'var(--text-mob-muted)', lineHeight: 1.6 }}>
              ...
              {wo.status === 'COMPLETED' && wo.stripe_payment_link && (
                <a
                  ...
                  style={{
                    ...
                    fontFamily: 'var(--font-mono-mob)', fontSize: 'clamp(0.8125rem, 3.5vw, 0.9375rem)', letterSpacing: '0.2em',
