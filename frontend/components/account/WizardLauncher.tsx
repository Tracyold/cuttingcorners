...
function TermsScreen({ onAccept }: TermsProps) {
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', padding: '32px 20px', display: 'flex', flexDirection: 'column' }}>
      <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 24, fontWeight: 400, color: 'var(--text)', marginBottom: 8, lineHeight: 1.2 }}>
        Before you begin
      </h2>
      <p style={{ fontFamily: 'var(--font-ui)', fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.7, marginBottom: 28 }}>
      ...
      <div style={{ background: 'var(--bg-card)', border: '0.5px solid var(--border)', padding: '20px', marginBottom: 20 }}>
        <p style={{ fontFamily: 'var(--font-ui)', fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.75 }}>
      ...
      <label style={{ display: 'flex', alignItems: 'flex-start', gap: 12, cursor: 'pointer', marginBottom: 32 }}>
        <input
          ...
          style={{ marginTop: 3, flexShrink: 0, accentColor: 'var(--gold)', width: 16, height: 16 }}
        />
        <span style={{ fontFamily: 'var(--font-ui)', fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.5 }}>
